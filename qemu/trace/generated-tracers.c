...
uint16_t _TRACE_VIRTIO_IRQ_DSTATE;
...
TraceEvent _TRACE_VIRTIO_IRQ_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "virtio_irq",
    .sstate = TRACE_VIRTIO_IRQ_ENABLED,
    .dstate = &_TRACE_VIRTIO_IRQ_DSTATE 
};
...
static void trace_common_register_events(void)
{
    trace_event_register_group(common_trace_events);
}
trace_init(trace_common_register_events)
