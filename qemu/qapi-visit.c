...
void visit_type_BlockdevOptions_members(Visitor *v, BlockdevOptions *obj, Error **errp)
{
    ...
    case BLOCKDEV_DRIVER_FTP:
        visit_type_BlockdevOptionsCurl_members(v, &obj->u.ftp, &err);
        break;
    case BLOCKDEV_DRIVER_FTPS:
        visit_type_BlockdevOptionsCurl_members(v, &obj->u.ftps, &err);
        break;
    ...
    case BLOCKDEV_DRIVER_HTTP:
        visit_type_BlockdevOptionsCurl_members(v, &obj->u.http, &err);
        break;
    case BLOCKDEV_DRIVER_HTTPS:
        visit_type_BlockdevOptionsCurl_members(v, &obj->u.https, &err);
        break;
...
out_obj:
    visit_end_struct(v, (void **)obj);
    if (err && visit_is_input(v)) {
        qapi_free_BlockdevOptionsArchipelago(*obj);
        *obj = NULL;
    }
out:
    error_propagate(errp, err);
...
void visit_type_BlockdevOptionsCurl_members(Visitor *v, BlockdevOptionsCurl *obj, Error **errp)
{
    Error *err = NULL;
...
void visit_type_BlockdevOptionsCurl(Visitor *v, const char *name, BlockdevOptionsCurl **obj, Error **errp)
{
    Error *err = NULL;

    visit_start_struct(v, name, (void **)obj, sizeof(BlockdevOptionsCurl), &err);
    if (err) {
        goto out;
    }
    if (!*obj) {
    ...
    visit_type_BlockdevOptionsCurl_members(v, *obj, &err);
    if (err) {
        goto out_obj;
    }
    visit_check_struct(v, &err);
out_obj:
    visit_end_struct(v, (void **)obj);
    if (err && visit_is_input(v)) {
        qapi_free_BlockdevOptionsCurl(*obj);
        *obj = NULL;
    }
out:
    error_propagate(errp, err);
...
void visit_type_BlockdevOptionsGluster_members(Visitor *v, BlockdevOptionsGluster *obj, Error **errp)
{
    ...
    visit_type_GlusterServerList(v, "server", &obj->server, &err);
    if (err) {
        goto out;
    }
    if (visit_optional(v, "debug-level", &obj->has_debug_level)) {
        visit_type_int(v, "debug-level", &obj->debug_level, &err);
        if (err) {
            goto out;
        }
    }
...
void visit_type_GlusterServer_members(Visitor *v, GlusterServer *obj, Error **errp)
{
    Error *err = NULL;

    visit_type_q_obj_GlusterServer_base_members(v, (q_obj_GlusterServer_base *)obj, &err);
    if (err) {
        goto out;
    }
    switch (obj->type) {
    ...
    case GLUSTER_TRANSPORT_TCP:
        visit_type_InetSocketAddress_members(v, &obj->u.tcp, &err);
        break;
    default:
        abort();
    }
...
void visit_type_GlusterServer(Visitor *v, const char *name, GlusterServer **obj, Error **errp)
{
    Error *err = NULL;

    visit_start_struct(v, name, (void **)obj, sizeof(GlusterServer), &err);
    if (err) {
        goto out;
    }
    if (!*obj) {
    ...
    visit_type_GlusterServer_members(v, *obj, &err);
    if (err) {
        goto out_obj;
    }
    visit_check_struct(v, &err);
...
void visit_type_GlusterServerList(Visitor *v, const char *name, GlusterServerList **obj, Error **errp)
{
    Error *err = NULL;
    GlusterServerList *tail;
    size_t size = sizeof(**obj);
    ...
    for (tail = *obj; tail;
         tail = (GlusterServerList *)visit_next_list(v, (GenericList *)tail, size)) {
        visit_type_GlusterServer(v, NULL, &tail->value, &err);
        if (err) {
            break;
        }
    }
    ...
    visit_end_list(v, (void **)obj);
    if (err && visit_is_input(v)) {
        qapi_free_GlusterServerList(*obj);
        *obj = NULL;
    }
out:
    error_propagate(errp, err);
...
void visit_type_GlusterTransport(Visitor *v, const char *name, GlusterTransport *obj, Error **errp)
{
    int value = *obj;
    visit_type_enum(v, name, &value, GlusterTransport_lookup, errp);
    *obj = value;
}
...
void visit_type_NetLegacyOptions_members(Visitor *v, NetLegacyOptions *obj, Error **errp)
{
    ...
    visit_type_NetLegacyOptionsKind(v, "type", &obj->type, &err);
    if (err) {
        goto out;
    }
    switch (obj->type) {
...
void visit_type_NetLegacyOptionsKind(Visitor *v, const char *name, NetLegacyOptionsKind *obj, Error **errp)
{
    int value = *obj;
    visit_type_enum(v, name, &value, NetLegacyOptionsKind_lookup, errp);
    *obj = value;
}
...
void visit_type_VncBasicInfoList(Visitor *v, const char *name, VncBasicInfoList **obj, Error **errp)
{
    ...
    for (tail = *obj; tail;
         tail = (VncBasicInfoList *)visit_next_list(v, (GenericList *)tail, size)) {
        visit_type_VncBasicInfo(v, NULL, &tail->value, &err);
        if (err) {
            break;
        }
    }
    ...
    visit_end_list(v, (void **)obj);
    if (err && visit_is_input(v)) {
        qapi_free_VncBasicInfoList(*obj);
        *obj = NULL;
    }
out:
    error_propagate(errp, err);
...
void visit_type_q_obj_GlusterServer_base_members(Visitor *v, q_obj_GlusterServer_base *obj, Error **errp)
{
    Error *err = NULL;

    visit_type_GlusterTransport(v, "type", &obj->type, &err);
    if (err) {
        goto out;
    }
